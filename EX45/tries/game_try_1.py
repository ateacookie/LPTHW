...
class Caught(Scene):
    ...
    def enter(self):
        print Caught.bye[rantint(0, len(self.bye)-1)]
        exit(1)
...
class SecretRoom(Scene):
    ...
    treasure = ["coins", "gold bars", "bills", "money bags"]
...
class Map(object):
    ...
    scenes = [Lobby(), DiningRoom(), Library(), SecretRoom(), Caught(), Finished()]
